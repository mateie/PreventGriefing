...
public class AutoExtendClaimTask implements Runnable
{
            ...
            int lowestExistingY)
    {
        ...
        this.minY = Math.max(
                ...
                PreventGriefing.instance.config_claims_maxDepth);
    }
    ...
    public void run()
    {
        ...
        {
            Bukkit.getScheduler().runTask(PreventGriefing.instance, new ExecuteExtendClaimTask(claim, newY));
        }
    }
    ...
    private record ExecuteExtendClaimTask(Claim claim, int newY) implements Runnable
    {
        ...
        public void run()
        {
            PreventGriefing.instance.dataStore.extendClaim(claim, newY);
        }
    }
